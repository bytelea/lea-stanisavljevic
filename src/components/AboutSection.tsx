        ...
        >
          ...
          <div className="space-y-6">
            <p className="text-muted-foreground leading-relaxed">
              I'm Lea — a Data Science and AI student at TU Dublin with a strong foundation
              in web development, digital marketing, and design. I'm passionate about
              turning raw data into meaningful insights and building intelligent systems.
            </p>
            <p className="text-muted-foreground leading-relaxed">
